...
public class Client {
	...
	public double classTwoAccessorOneMethodTwo() throws SomeException112, SomeException110 {
		Object raw = broker.getNameService().resolve("TwoAccessorOne");
		ClassTwoImplBase base = ClassTwoImplBase.narrowCast(raw);
		base.methodOne(2);
	...
	public double classTwoAccessorOneMethodTwoError() throws SomeException112, SomeException110 {
		Object raw = broker.getNameService().resolve("TwoAccessorOne");
		ClassTwoImplBase base = ClassTwoImplBase.narrowCast(raw);
		base.methodOne(0);
		return base.methodTwo();	
	...
	public double classOneAccessorTwoMethodOne() throws accessor_two.SomeException112{
		Object raw = broker.getNameService().resolve("OneAccessorTwo");
		accessor_two.ClassOneImplBase base = accessor_two.ClassOneImplBase.narrowCast(raw);
		return base.methodOne("bla", 1);		
	}
	
	public double classOneAccessorTwoMethodOneError() throws accessor_two.SomeException112{
		Object raw = broker.getNameService().resolve("OneAccessorTwo");
		accessor_two.ClassOneImplBase base = accessor_two.ClassOneImplBase.narrowCast(raw);
		return base.methodOne("", 1);		
	}
	
	public double classOneAccessorTwoMethodTwo() throws accessor_two.SomeException112, SomeException304{
		Object raw = broker.getNameService().resolve("OneAccessorTwo");
		accessor_two.ClassOneImplBase base = accessor_two.ClassOneImplBase.narrowCast(raw);
		return base.methodTwo("bla", 1);		
	}
	
	public double classOneAccessorTwoMethodTwoError112() throws accessor_two.SomeException112, SomeException304{
		Object raw = broker.getNameService().resolve("OneAccessorTwo");
		accessor_two.ClassOneImplBase base = accessor_two.ClassOneImplBase.narrowCast(raw);
		return base.methodTwo("", 1);		
	}
	
	public double classOneAccessorTwoMethodTwoError304() throws accessor_two.SomeException112, SomeException304{
		Object raw = broker.getNameService().resolve("OneAccessorTwo");
		accessor_two.ClassOneImplBase base = accessor_two.ClassOneImplBase.narrowCast(raw);
